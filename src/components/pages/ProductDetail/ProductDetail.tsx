...
const features = [
  {
    id: 1,
    title: 'Поворотный',
    description: 'Легко изменяется направление светового потока.',
    image: {
      absolute_url:
