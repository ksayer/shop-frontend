...
function filterProperties(
  ...
  return checkingProperties.every(
    prop => activeProduct.property[prop]?.title === checkingProduct.property[prop]?.title,
  );
}
...
const SWITCH_PROPERTIES: Array<keyof typeof PROPERTIES> = [
  'body_color',
  'frame_color',
  'cover_color',
];
