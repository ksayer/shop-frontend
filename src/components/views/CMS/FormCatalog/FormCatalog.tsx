...
const text =
  'Наши персональные консультанты отправят вам полный каталог по всему ассортименту компании.';
    ...
    <Section>
      <div className={styles.wrapper}>
        <div className={styles.bg}>
          <Image
            src={
              'https://ledmonster.ru/media/filer_public/d2/cd/d2cd1822-0c30-4110-b1ad-d36e85e73f20/cat2020_desk.jpg'
            }
            alt={'bg'}
            fill
